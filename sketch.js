...
function preload() {
  ...
  images.push(loadImage('CDs/CD2.png'));
  images.push(loadImage('CDs/CD3.png'));
}
...
function setup() {
  ...
  let cdButton = createImg('CDs/CD1.png','cd1');
  cdButton.size(100, 100);
  cdButton.position(width / 2 - 50, height / 2 - 50);
 
  cdButton.mousePressed(toggleVideo);
